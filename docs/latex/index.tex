...
\item 1.\+1.\+3 (2016-\/10-\/12)\+: Fixed a bug that caused the buzzer\textquotesingle{}s {\ttfamily is\+Playing} method to malfunction sometimes when link time optimization is enabled. Also incorporated some minor fixes to the \hyperlink{class_q_t_r_sensors}{Q\+T\+R\+Sensors} and \hyperlink{class_l_s_m303}{L\+S\+M303} libraries.
